...
const Navbar = () => {
    return (
        <>
            <nav className = 'w-full flex flex-wrap justify-between items-center bg-white/25 border border-white shadow-[0_3px_10px_rgba(0,0,0,0.05)] rounded-xl px-3 p-1'>
                ...
                <div className = 'w-2/12 bg-bl ue-200 flex flex-wrap justify-center items-center gap-2'>
