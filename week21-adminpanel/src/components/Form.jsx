    ...
    return (
        <>
            <div className = 'relative w-full h-screen flex flex-wrap justify-center items-center'>
                ...
                <div className = 'w-3/12 flex flex-wrap gap-7 py-5 px-3 justify-center items-center bg-neutral-200/5 border border-white shadow-[0_5px_15px_rgba(0,0,0,0.055)] backdrop-blur-xl rounded-3xl'>
