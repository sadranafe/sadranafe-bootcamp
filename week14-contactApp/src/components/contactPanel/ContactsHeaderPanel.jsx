...
const ContactsHeaderPanel = ({ onDUMMYCONTACTS , search , searchHandler , sortContactsHandler , selectedContact , isSelecting , onSelectedContact , onIsSelecting , selectedGroupContacts , setToast , onToastIsFired }) => {
