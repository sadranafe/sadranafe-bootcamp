...
const ContactsPanel = ({ DUMMYCONTACTS , onDUMMYCONTACTS , modelIsOpen , onModelIsOpen }) => {
    return (
        <>
            <div className = 'w-8/12 h-full overflow-hidden transition-all duration-500'>
                ...
                <ContactsMainPanel DUMMYCONTACTS = {DUMMYCONTACTS} onDUMMYCONTACTS = {onDUMMYCONTACTS} onModelIsOpen = {onModelIsOpen}/>
            </div>
        </>
    );
};
