const ModelInput = ({ inputType , labelName , labelIcon }) => {
    return (
        <>
            <div className = {`border-white/50 bg-white/20 border shadow-[0_5px_10px_rgba(0,0,0,0.05)] rounded-lg px-3 gap-3 flex justify-start items-center`}>
                ...
                <input type = { inputType } name = {labelName} id = {labelName} placeholder = {labelName} className = 'w-full py-3 text-cyan-700 placeholder:text-gray-500'/>
            </div>
        </>
    );
};
